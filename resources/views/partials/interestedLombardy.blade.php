 <!-- Interested Modal -->
<div class="modal fade" id="interestedLombardy" tabindex="-1" role="dialog" aria-labelledby="interestedLombardy" aria-hidden="true">
        ...
        <div class="modal-content px-0 px-md-4">
            ...
            <div class="modal-body">
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <form id="mainForm" method="POST" action="/interested-lombardy/{{ $unit->id }}" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                            <div class="modal-body">
...
<script>
    $('#interestedLombardy').on('shown.bs.modal', function () {
