...
@section('title', 'Residential Sale Listing')
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="my-4">List Residential Sale Property</h1>
        </div>
    </div>
    <div class="row mb-4">
        <div class="col-md-12">
            <form id="mainForm" method="POST" action="/list-residential-sale" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
