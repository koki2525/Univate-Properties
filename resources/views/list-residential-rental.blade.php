...
@section('title', 'List Residential Rental')
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="my-4">List Residential Rental Property</h1>
        </div>
    </div>
    <div class="row mb-4">
        <div class="col-md-12">
            <form id="mainForm" method="POST" action="/list-residential-rental" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
