...
<head>
	...
	<title>Uni-vate Properties | Commercial Rentals</title>
...
<h1 style="text-align:center;">Residential Rentals</h1>
...
<div>
  ...
  @foreach($rentals as $rental)
			<a style="text-transform: uppercase;" href="/residential-rental/{{ $rental->name }}"> - {{ $rental->name }} </a><br>
  @endforeach 
  </div>
</div>
...
<div class="row">
<p style="text-align:center;margin-bottom: 5rem;">* For holiday rentals  <a target="_blank" href="https://www.tradeunipoint.com/">click here</a>
</p>
</div>
