...
<script>
    ...
    function Conform_Delete() {
        return confirm("Are you sure want to delete this residential property?");
    }
        ...
        <div class="col-md-10 offset-md-1">
           <!-- <form id="mainForm" method="POST" action="/search" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
                ...
                <h1>All Resindetial Properties</h1>
        </div>
    </div>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $residential->propertType }}</td>

                        @if($residential->published==1)
                        <td class="text-center">
                            <a href="/publishResidential/{{ $residential->id }}">
                        ...
                        <td class="text-center">
                            <a href="/edit-residential/{{ $residential->id }}">
                                <i class="far fa-edit blue-text fa-2x"></i>
                            </a>
                        </td>

                        <td class="text-center">
                            <a onclick="return Conform_Delete()" href="/deleteResidential/{{ $residential->id }}">
