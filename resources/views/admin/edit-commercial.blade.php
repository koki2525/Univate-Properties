...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="my-4">Edit Commercial Property Details</h1>
        </div>
    </div>

    <form  enctype="multipart/form-data" role="form" method="POST" action="/edit-commercial/{{ $commercial->id }}">
        @csrf
        <div class="form-row">
                <div class="col-md-6">
        ...
        <div class="form-row">
            <div class="col-md-6">
                <a class="btn btn-blue" href="/commercial-admin">BACK</a>
            </div>
            <div class="col-md-6">
