...
<script>
    ...
    function Conform_Delete() {
        return confirm("Are you sure want to delete this agent?");
    }
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $agent->phone }}</td>
                        <td>{{ $agent->agency }}</td>
                        @if($agent->agent_publish==1)
                        <td class="text-center">
                            <a href="/publishAgent/{{ $agent->id }}">
                        ...
                        <td class="text-center">
                            <a href="/edit-agent/{{ $agent->id }}">
                                <i class="far fa-edit blue-text fa-2x"></i>
                            </a>
                        </td>

                        <td class="text-center">
                            <a onclick="return Conform_Delete()" href="/deleteAgent/{{ $agent->id }}">
