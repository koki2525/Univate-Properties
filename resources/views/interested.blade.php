...
<head>
    @extends('master')
	<base href="https://www.univateproperties.co.za/old/index.php/about" />
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="About, Uni-Vate, Properties" />
	<meta name="author" content="Super User" />
	<meta name="description" content="About Uni-Vate Properties" />
	...
	<link href="/old/modules/mod_jmslideshow/assets/css/mod_jmslideshow_default.css" rel="stylesheet" type="text/css" />
	...
	<script src="/old/media/system/js/caption.js?6364477b993bf38d3386797c3bd632f0" type="text/javascript"></script>
...
<div style="padding-left:0 !important;padding-right:0 !important;width: 100% !important;max-width: 100% !important;" id="t3-mainbody" class="t3-mainbody">
		<!-- MAIN CONTENT -->
		<a href="{{ URL::previous() }}"><button style="margin-left:auto;margin-right:auto;display:block;background: #073364;border-radius: 3rem;"><i class="fa fa-caret-square-o-left" aria-hidden="true"></i> Back</button></a>
		
		<form id="mainForm" method="POST" action="/interested/{{ $timeshare->id }}" accept-charset="UTF-8" enctype="multipart/form-data">
        
			<h4 style="text-align:center;">Resort Information</h4>

            <div class="row">
                <div class="large-3 columns">
                    <label style="font-weight:bolder;">Resort Name</label>
                    {{ $timeshare->resort }}
                </div>
                <div class="large-3 columns">
                    <label style="font-weight:bolder;">Week</label>
                    {{ $timeshare->week }}
                </div>
                <div class="large-3 columns">
			...
			<p style="text-align:center;">Please submit your contact details and a Uni-Vate agent will be in contact with you shortly  to assist with the week that you are interested in.</p>
                        ...
                        <div class="row">
                            <button style="margin-left:auto;margin-right:auto;display:block;" id="submit" type="submit" class="brochure">SEND</button>
                        </div>
           </form>
</div> 
