...
@section('title', 'Commercial Properties Agents')
    ...
    <div class="row mb-4 mt-5">
        <div class="col-md-10 offset-md-1">
            ...
            @csrf
                ...
                <h1>Commercial Properties Agents</h1>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/publishCommercialAgent/{{ $agent->id }}">
                        ...
                        <td class="text-center">
                            <a href="/edit-commercial-agent/{{ $agent->id }}">
                                <i class="far fa-edit blue-text fa-2x"></i>
                            </a>
                        </td>

                        <td class="text-center">
                            <a onclick="return Conform_Delete()" href="/deleteCommercialAgent/{{ $agent->id }}">
