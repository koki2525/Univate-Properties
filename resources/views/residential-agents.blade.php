...
@section('title', 'Residential Properties Agents')
...
<script>
    ...
    function Conform_Delete() {
        return confirm("Are you sure want to delete this commercial properties agent?");
    }
    ...
    <div class="row mb-4 mt-5">
        <div class="col-md-10 offset-md-1">
            ...
            @csrf
                ...
                <h1>Residential Properties Agents</h1>
        </div>
    </div>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $agent->phone }}</td>
                        <td>{{ $agent->agency }}</td>
                        <td>{{ $agent->registrationNum }}</td>
                        <td>{{ $agent->EAAB_FFC_Number }}</td>
                        @if($agent->residential_publish==1)
                        <td class="text-center">
                            <a href="/publishResidentialAgent/{{ $agent->id }}">
                        ...
                        <td class="text-center">
                            <a href="/edit-residential-agent/{{ $agent->id }}">
                                <i class="far fa-edit blue-text fa-2x"></i>
                            </a>
                        </td>

                        <td class="text-center">
                            <a onclick="return Conform_Delete()" href="/deleteResidentialAgent/{{ $agent->id }}">
